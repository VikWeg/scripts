...
/**/	int VoxCount = cube_size[0] * cube_size[1] * cube_size[2];
...
/**/	char* wx_str = "1";												/**/
/**/																	/**/
/**/	__host__ __device__ float wc(float T) { return 1 / T; }								/**/
/**/	__host__ __device__ float wx(float T) { return 1; }
/**/
/**/	__host__ __device__ float wint(float cos,Constant Const) { return (1 + cos) / (1 - cos + Const.eps); }
