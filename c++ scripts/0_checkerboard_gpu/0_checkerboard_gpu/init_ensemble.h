...
void init_ensemble()
{
	...
	Const.delta = delta;
	Const.nx = nx;
	Const.SpinCount = scount;
	Const.VoxCount = VoxCount;
	Const.c0 = cube_size[0];
	Const.c1 = cube_size[1];
	Const.c2 = cube_size[2];
	Const.pixdim0 = hdr.pixdim[1];
	Const.pixdim1 = hdr.pixdim[2];
	Const.pixdim2 = hdr.pixdim[3];
	Const.eps = eps;
