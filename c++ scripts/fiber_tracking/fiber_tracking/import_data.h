void import_data()
{
	...
	//******** Open data file ********
	FILE* data_file = fopen("C:/ETH/Neuro/GlobalTracking/1159/1159_tensor.nii", "rb");
	if (data_file == NULL)
	{
	...
	//******** Open data file ********
	FILE* L1_file = fopen("C:/ETH/Neuro/GlobalTracking/1159/1159_L1.nii", "rb");
	if (L1_file == NULL)
	{
		fprintf(stderr, "\nError opening data file\n");
	}
	...
	//******** Open data file ********
	FILE* L3_file = fopen("C:/ETH/Neuro/GlobalTracking/1159/1159_L3.nii", "rb");
	if (L3_file == NULL)
	{
		fprintf(stderr, "\nError opening data file\n");
	}
	...
	//******** Open data file ********
	FILE* L2_file = fopen("C:/ETH/Neuro/GlobalTracking/1159/1159_L2.nii", "rb");
	if (L2_file == NULL)
	{
		fprintf(stderr, "\nError opening data file\n");
	}
