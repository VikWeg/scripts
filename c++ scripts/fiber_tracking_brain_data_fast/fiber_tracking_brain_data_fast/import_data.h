void import_data()
{
	FILE* header_file = fopen("C:/ETH/Neuro/GlobalTracking/1159T/1159T_tensor.nii", "r");
	if (header_file == NULL)
	{
	...
	//******** Open data file ********
	FILE* data_file = fopen("C:/ETH/Neuro/GlobalTracking/1159T/1159T_tensor.nii", "rb");
	if (data_file == NULL)
	{
	...
	//******** Open data file ********
	FILE* L1_file = fopen("C:/ETH/Neuro/GlobalTracking/1159T/1159T_L1.nii", "rb");
	if (L1_file == NULL)
	{
		fprintf(stderr, "\nError opening data file\n");
	}
	...
	//******** Open data file ********
	FILE* L3_file = fopen("C:/ETH/Neuro/GlobalTracking/1159T/1159T_L3.nii", "rb");
	if (L3_file == NULL)
	{
		fprintf(stderr, "\nError opening data file\n");
	}
	...
	//******** Open data file ********
	FILE* L2_file = fopen("C:/ETH/Neuro/GlobalTracking/1159T/1159T_L2.nii", "rb");
	if (L2_file == NULL)
	{
		fprintf(stderr, "\nError opening data file\n");
	}
	...
	//******** Open data file ********
	FILE* mask_file = fopen("C:/ETH/Neuro/GlobalTracking/1159T/wm_mask_diff.nii", "rb");
	if (mask_file == NULL)
	{
		fprintf(stderr, "\nError opening data file\n");
	}
