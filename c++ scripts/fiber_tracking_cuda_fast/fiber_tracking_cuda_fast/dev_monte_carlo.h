...
__device__ void mc_x(
		...
		float T, int id, parameters* params
	)
	{
		...
		for (int i = 0; i < params->nx; i++)
		{
			...
			x = x0 - (x0 - pos_x[id] + params->pix_dim_x * 0.5) * params->delta_x + curand_uniform(&s)* params->delta_x;
			y = y0 - (y0 - pos_y[id] + params->pix_dim_y * 0.5) * params->delta_x + curand_uniform(&s)* params->delta_x;
			z = z0 - (z0 - pos_z[id] + params->pix_dim_z * 0.5) * params->delta_x + curand_uniform(&s)* params->delta_x;
